...
<head>
	...
	<link rel="stylesheet" href="/brim/dashboard_accet/vendor/chartist/css/chartist.min.css">
	<script src="//cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    <link href="/brim/dashboard_accet/vendor/bootstrap-select/dist/css/bootstrap-select.min.css" rel="stylesheet">
	<script src="//cdn.jsdelivr.net/npm/sweetalert2@11"></script>
	<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
	<link href="/brim/dashboard_accet/vendor/owl-carousel/owl.carousel.css" rel="stylesheet">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
                <img class="logo-abbr" src="/brim/dashboard_accet/images/logo.png" alt="">
                <img class="logo-compact" src="/brim/dashboard_accet/images/logo-text.png" alt="">
                <img class="brand-title" src="/brim/dashboard_accet/images/logo-text.png" alt="">
            </a>
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                                    <img src="/brim/uploads/user/<?=$after_accos['image']?>" width="20" alt=""/>
									
									
									<div class="header-info">

									
										<span class="text-black"><strong><?=$after_accos['name']?></strong></span>
										<p class="fs-12 mb-0">Super Admin</p>
									</div>
                                </a>
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="users/profile.php" class="dropdown-item ai-icon">
				...
				<ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/brim/users/user.php">User list</a></li>
					...
					<li><a class=" has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
					 ...
					 <li><a class=" has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
							...
							<li><a href="/brim/banner_content/banner_image.php">Add Image</a></li>
					 ...
					 <li><a class=" has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/brim/education/education.php">Add Education</a></li>
							<li><a href="/brim/education/education_banner.php">Add About</a></li>
							<li><a href="/brim/education/education_image.php">Add image</a></li>
					 ...
					 <li><a class=" has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/brim/service/service.php">Add Service</a></li>
					  ...
					  <li><a class=" has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/brim/Portfolio/Portfolio.php">Add Portfolio</a></li>
					 ...
					 <!-- end -->
					  ...
					  <li><a class=" has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/brim/testimonial/testimonial_img.php">Add image</a></li>
							<li><a href="/brim/testimonial/text.php">Add text</a></li>
					 ...
					 <!-- end -->
					   ...
					   <li><a class=" has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/brim/brand/brand.php">Add Brand</a></li>
					 ...
					 <!-- end -->
					   ...
					   <li><a class=" has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-television"></i>
							<span class="nav-text">Worke</span>
							</a>

                        <ul aria-expanded="false">
                            <li><a href="/brim/worke/worke.php">Add Worke</a></li>
                        </ul>
                     </li>
					 ...
					 <!-- end -->
					   ...
					   <li><a class=" has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/brim/contact/contact.php">Add Contact</a></li>
                        </ul>
                     </li>
