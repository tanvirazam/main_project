...
$user_id=$after_accos['use_id'];


// user information
$selects="SELECT * FROM user WHERE id=$user_id";
$select_ress=mysqli_query($db_connection,$selects);

$after_accoss=mysqli_fetch_assoc($select_ress);
                        ...
                        <div class="col-xl-9 col-lg-10">
                            <div class="single-blog-list">
                                <div class="blog-list-thumb mb-35">
                                    <img src="uploads/work/<?=$after_accos['image']?>" alt="img">
                                </div>
                                <div class="blog-list-content blog-details-content portfolio-details-content">
                                    <h2><?=$after_accos['sub_title']?></h2>
                                    <p><?=$after_accos['title']?></p>
                                    ...
                                    <ul>
                                        <li>
                                            <div class="post-avatar-img">
                                                <img width="100" src="uploads/user/<?=$after_accoss['image']?>" alt="img">
                                            </div>
